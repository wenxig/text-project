//const { updateImage } = require("../controllers/articleCaseController")
...
const articleCaseModel = {
  ...
  updateImage:'update ev_article_cate set pic_Url=? where id=?',
  uploadImg:'select pic_Url from ev_article_cate where id=?',
  //uploadImg:'select user_pic from ev_users where id=?',
}
